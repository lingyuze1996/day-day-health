...
export function RecordLineChart(props) {
    ...
    switch (metrics) {
        case "bp":
            ...
            lines.push(<Line key="bpHigh" yAxisId="left" type="monotone" dataKey="bpHigh" strokeWidth={2} stroke="#ff6d00" />)
            lines.push(<Line key="bpLow" yAxisId="left" type="monotone" dataKey="bpLow" strokeWidth={2} stroke="#5c6bc0" />)
            break
        ...
        case "bs":
            ...
            lines.push(<Line key="bs" yAxisId="left" type="monotone" dataKey="bs" strokeWidth={2} stroke="#ad1457" fill="#ad1457" />)
            break
        default:
            break
    }
